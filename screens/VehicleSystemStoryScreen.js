...
export default function VehicleSystemStoryScreen(props) {
  ...
  const assetIdFromRoute =
    route?.params?.assetId ?? route?.params?.vehicleId ?? currentVehicle?.id ?? null;
  ...
  }, [assetId, assetKac, assetName, assignedPros, navigation, system?.name, systemId]);
    ...
    <SafeAreaView style={layoutStyles.screen}>
      <View style={styles.container}>
        ...
        <View style={styles.headerChipsRow}>
          ...
          <TouchableOpacity style={styles.chip} onPress={handleShareServiceReady}>
            <Ionicons
          ...
          <TouchableOpacity style={styles.chip} onPress={handleOpenMessages}>
            <Ionicons
