      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.brandRow}>
          <View style={styles.brandLeft}>
            ...
            <Text style={styles.brandUrl}>https://app.keeprhome.com</Text>
          </View>
        ...
        <View style={styles.titleBlock}>
          ...
          <View style={styles.metaRow}>
            {purchaseDate ? (
              <Text style={styles.metaText}>{formatKeeprDate(String(purchaseDate).slice(0, 10))}</Text>
            ) : null}
            {subtitle ? (
              <>
        ...
        {(purchasePrice || purchaseDate) && (
          <View style={styles.section}>
            ...
            {purchaseDate ? (
              <Text style={styles.sectionBody}>
                Date: {formatKeeprDate(String(purchaseDate).slice(0, 10))}
              </Text>
            ) : null}
          </View>
        )}
