...
{IS_WEB && (
    ...
    dangerouslySetInnerHTML={{
      __html: `
        @media print {
          ...
          /* ...except the Keepr story print root and its children */
          #keepr-print-root,
          #keepr-print-root * {
  ...
  />
      ...
      <View style={{ flex: 1 }} nativeID="keepr-print-root">
...
sheet: {
  width: "100%",
  maxWidth: 720,// ~7.5" at 96dpi → fits inside 0.5" margins
...
heroImage: {
  width: "100%",
  aspectRatio: 4 / 3,   // same hero aspect as your story screens
},
