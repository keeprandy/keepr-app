-- KeeprSpace Activator inventory creates canonical assets plus org relationships.
-- The canonical asset must use an allowed public.assets.asset_mode value; the
-- org inventory/dealer state belongs on asset_relationships.metadata.
...
begin
  ...
  values (
    ...
    jsonb_strip_nulls(jsonb_build_object(
      ...
      'canonical_asset_mode', 'commercial',
