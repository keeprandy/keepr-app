-- Keepr Effect V1: privacy-safe personal member impact reporting.
-- Source of truth remains the Activation Engine attribution ledger.
...
begin
  ...
  select nullif(trim(p.acquisition_source_slug), '')
    into profile_slug
